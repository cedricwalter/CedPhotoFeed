...
<div class="module<?php echo $moduleclass_sfx ?>"
    ...
    <div style="text-align: center;">
        <a href="//www.galaxiis.com/cedphotofeed-showcase"
           ...
           onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'" target="_blank"><strong>cedphotofeed</strong></a>
    </div>
</div>
